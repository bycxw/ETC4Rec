...
"""Run masked LM/next sentence masked_lm pre-training for BERT or ETC."""
...
flags.DEFINE_string(
    ...
    "The config json file corresponding to the BERT or ETC model. "
...
def input_fn_builder(input_files,
    ...
    def input_fn(params):
        ...
        if global_seq_length > 0:
            name_to_features["global_input_ids"] = tf.FixedLenFeature([global_seq_length], tf.int64)
